...
class CustomerControllerTest {
    ...
    fun `should create customer`() {
        val request = PostCustomerRequest("fake name", "${UUID.randomUUID()}@email.com", "123456")
    ...
    fun `should throw error when create customer has invalid information`() {
        val request = PostCustomerRequest("", "${UUID.randomUUID()}@email.com", "123456")
    ...
    fun `should update customer`() {
        val customer = customerRepository.save(buildCustomer())
        val request = PutCustomerRequest("Maria", "${UUID.randomUUID()}@email.com")
    ...
    @Test
    fun `should return not found whe update customer not existing`() {
        val request = PutCustomerRequest("Maria", "${UUID.randomUUID()}@email.com")
    ...
    fun `should throw error when update customer has invalid information`() {
        val request = PutCustomerRequest("", "${UUID.randomUUID()}@email.com")
